    ...
    <div className="min-h-screen bg-[#FAFBFF]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        <button
          ...
          className="text-sm text-gray-500 hover:text-gray-900 mb-6 transition-colors inline-flex items-center gap-1"
        >
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6">
          <div className="flex items-start justify-between mb-5 gap-3">
            <div className="min-w-0">
              <h1 className="text-lg font-semibold text-gray-900 tracking-tight truncate">{task.title}</h1>
              <p className="text-sm text-gray-400 font-mono mt-0.5">{task.operationType.toLowerCase()}</p>
            </div>
          ...
          <div className="border-t border-gray-100 pt-5">
            <div className="grid md:grid-cols-2 gap-4 items-stretch">
              <div className="flex flex-col">
                <p className="text-[11px] font-medium uppercase tracking-wide text-gray-400 mb-2">Input text</p>
                <div className="rounded-lg bg-gray-50 ring-1 ring-gray-200 p-3.5 flex-1 overflow-y-auto">
                  <p className="text-sm text-gray-900 whitespace-pre-wrap">{task.inputText}</p>
                </div>
              </div>
          ...
          <div className="border-t border-gray-100 mt-5 pt-5">
            <p className="text-[11px] font-medium uppercase tracking-wide text-gray-400 mb-2">Execution logs</p>
