      ...
      <div className="w-full max-w-[420px] md:max-w-[460px]">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgba(30,64,175,0.08)] border border-[#E7ECF6] dark:border-gray-800 overflow-hidden">
          ...
          <div className="px-6 pt-7 pb-7 sm:px-8 sm:pt-8 sm:pb-8 md:px-10 md:pt-10 md:pb-10">
            <h2 className="text-lg md:text-xl font-semibold text-[#111827] dark:text-gray-100 tracking-tight leading-tight mb-1">Create your account</h2>
            <p className="text-xs md:text-sm text-[#6B7280] dark:text-gray-400 mb-6 md:mb-7">Start running AI processing tasks</p>

            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
              <div>
                <label className="block text-xs md:text-sm font-medium text-[#374151] dark:text-gray-300 mb-1.5">Name</label>
              ...
              <div>
                <label className="block text-xs md:text-sm font-medium text-[#374151] dark:text-gray-300 mb-1.5">Password</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#9CA3AF] dark:text-gray-500">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
